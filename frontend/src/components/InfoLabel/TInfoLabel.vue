...
.label__info {
  @apply relative flex items-center justify-center rounded border border-border-default bg-naturals-n3 px-3 py-2 text-xs text-naturals-n10;
  width: 150px;
  z-index: 0;
}
.label__info::before {
  content: '';
  @apply absolute block h-3 w-3 border border-t-0 border-r-0 border-border-default bg-naturals-n3;
  border-radius: 1px;
